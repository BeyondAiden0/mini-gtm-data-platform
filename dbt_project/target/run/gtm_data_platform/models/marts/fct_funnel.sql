    ...
    create  table
      "data"."marts"."fct_funnel__dbt_tmp"
...
with leads as (
    select * from "data"."staging"."stg_leads"
),
...
lead_activity_stats as (
    ...
    from "data"."staging"."stg_lead_activities"
    group by lead_id
),
...
first_campaign as (
    ...
    from "data"."staging"."stg_lead_activities" la
    inner join "data"."staging"."stg_campaigns" c on la.campaign_id = c.campaign_id
